    ...
    <div className="min-h-screen flex flex-col md:flex-row" style={{ background: "#F7F5EF" }}>
      ...
      >
        ...
        >
          ...
          {/* stat strip */}
          <div
            className="flex gap-0 mt-4 pt-6 border-t"
            style={{ borderColor: "rgba(255,255,255,0.06)" }}
          >
            {[
              { num: "€ 0",  label: "to start"  },
              { num: "100%", label: "private"    },
              { num: "<30s", label: "per report" },
            ].map((s, i) => (
              <div
                key={i}
                className={`flex-1 ${i > 0 ? "pl-4 border-l" : ""} ${i < 2 ? "pr-4" : ""}`}
                style={{ borderColor: "rgba(255,255,255,0.06)" }}
              >
                <div
                ...
                <div className="text-[9px] uppercase tracking-[0.09em]" style={{ color: "rgba(255,255,255,0.22)" }}>
                  {s.label}
                </div>
              </div>
            ))}
      ...
      {/* ── RIGHT — auth form ── */}
      <div
        className="w-full md:w-1/2 flex flex-col justify-center items-center p-8 sm:p-12 lg:p-20"
      ...
      >
        ...
        >
          ...
          {!isError && isLoading && (
            <p
              className="text-center text-[11px] font-medium mt-4 animate-pulse tracking-wider uppercase"
              style={{ color: "#C49A3C" }}
            >
              {status}
            </p>
          ...
          <div className="flex items-center gap-4 my-8">
            ...
            <span className="text-[10px] uppercase tracking-[0.1em]" style={{ color: "#c4bdb5" }}>
              secure login
            </span>
            <div className="flex-1 h-px" style={{ background: "#E0DACC" }} />
          </div>
